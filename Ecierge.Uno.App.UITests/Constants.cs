namespace Ecierge.Uno.App.UITests;

public class Constants
{
    public readonly static string WebAssemblyDefaultUri = "http://localhost:5000/";
    public readonly static string iOSAppName = "com.ecierge.uno.app";
    public readonly static string AndroidAppName = "com.ecierge.uno.app";
