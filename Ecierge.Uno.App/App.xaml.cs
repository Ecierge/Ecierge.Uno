...
public partial class App : Application
{
    ...
    private static void RegisterRoutes(IViewRegistryBuilder views, INavigationDataRegistryBuilder data, IRouteRegistryBuilder routes)
    {
        views.Register(
            ...
            new ViewMap<PageContentControlPage, PageContentControlViewModel>()
        );
        ...
        routes.Register((views, data) => [
            ...
            //    [
                    ...
                    new ("PageContentControl", views[typeof(PageContentControlPage)], new DataSegment("name", data[typeof(Entity)]))
            //    ]
            //)
            ]
        );
